...
variable "aks_cluster_name" {
  description = "Name of the existing AKS cluster whose node resource group contains the load balancer security group."
  type        = string
}
...
variable "aks_nsg_rule_name" {
  description = "Name of the AKS node NSG rule that allows HTTP from Azure Firewall to the AKS load balancer."
  type        = string
}

variable "aks_nsg_rule_priority" {
  description = "Priority of the AKS node NSG rule that allows HTTP from Azure Firewall to the AKS load balancer."
  type        = number
}
